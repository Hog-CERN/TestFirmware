...
#7 segment display
set_property PACKAGE_PIN W7 [get_ports {Empty}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Empty}]
set_property PACKAGE_PIN W6 [get_ports {Full}]					
...
##Buttons
set_property PACKAGE_PIN U18 [get_ports WriteEn]						
	set_property IOSTANDARD LVCMOS33 [get_ports WriteEn]
set_property PACKAGE_PIN T18 [get_ports ReadEn]						
